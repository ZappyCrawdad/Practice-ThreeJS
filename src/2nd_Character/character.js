...
export function loadFBXPersonaje(scene, onLoad = () => {}) { //* 'scene': Lugar donde pondremos el personaje. 'onLoad': Funcion opcional que se ejecuta cuando todo ha terminado de cargarse (modelo y animaciones).
    ...
    loader.load('/models/character-2/X Bot.fbx', (fbx) => { //Se crea un"cargador" ('fbx') para traer los archivos '.fbx' desde el disco.
        ...
        const animationPaths = { //Objeto que contiene los combres de las animaciones
            idle:'/models/character-2/animations/Standing Idle.fbx',
            walk: '/models/character-2/animations/Dwarf Walk.fbx',
            back: '/models/character-2/animations/Happy Walk Backward.fbx',
            startwalk: '/models/character-2/animations/Female Stop Walking.fbx',
            endwalk: '/models/character-2/animations/Female Start Walking.fbx'
        };
